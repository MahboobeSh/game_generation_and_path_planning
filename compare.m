...
% Plot the results
   ...
   % Plot the restricted areas
    ...
    segment_curve = bezier_curve(segment_control_points, num_samples);
    ...
    path = dynamic_path;
    save(fullFileName, 'X_e','X_s','Start_points','End_points','path','step_size','m','avoid_radius', 'visited_nodes','curve', 'curve_segment_points', 'variables_matrix','-append');
